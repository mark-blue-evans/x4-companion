# VKB Gladiator NTX EVO X4 bindings (codejnki/x4_vkb)

Source: https://github.com/codejnki/x4_vkb (MIT)
Vendored as-is so the assistant can reference the user's actual button bindings
when answering "how do I X?". Keep this file in sync if you update your VKB cfg.
